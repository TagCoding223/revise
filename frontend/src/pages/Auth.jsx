          ...
          >
            <form onSubmit={handleLoginSubmit(onLogin)} className="space-y-5">
              ...
              <button
                ...
                className="w-full py-2.5 px-4 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 dark:disabled:bg-blue-800 disabled:cursor-not-allowed text-white font-medium rounded-lg transition-colors flex justify-center items-center cursor-pointer"
              >
                {isSubmitting ? (
          ...
          >
            <form onSubmit={handleSignupSubmit(onSignup)} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full py-2.5 px-4 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 dark:disabled:bg-blue-800 disabled:cursor-not-allowed text-white font-medium rounded-lg transition-colors flex justify-center items-center mt-2 cursor-pointer"
              >
                {isSubmitting ? (
                  <span className='flex gap-2 items-center'>
                    <svg className="animate-spin h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
